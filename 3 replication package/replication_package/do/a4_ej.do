//appendix a4: EFFECTS ON PROFIT AND COMPONENTS OF TOTAL INPUT COST
...
profit profit_w1 profit_sinh

rcotton_w1 rwheat_w1 rcumin_w1

total_input_cost total_input_cost_w1 inputcost_sinh

totcost_irrig_rs totcost_irrig_rs_w1  irrig_sinh
...
lazystar, table(t) columns(1(2)36) coefs(50) rowgap(5) outsheet(../out/a4_ej);
